...
if [ "$darwin" = "true" ]; then
    case $JVM_ARCH in
    x86_64)
        JVM_URL=https://download.oracle.com/java/21/latest/jdk-21_macos-x64_bin.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jdk-21_macos-x64_bin-f8ac0c
        ;;
    arm64)
        JVM_URL=https://download.oracle.com/java/21/latest/jdk-21_macos-aarch64_bin.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jdk-21_macos-aarch64_bin-8b4611
        ;;
    *) 
    ...
    JVM_URL=https://download.oracle.com/java/21/latest/jdk-21_windows-x64_bin.zip
    JVM_TARGET_DIR=$BUILD_DIR/jdk-21_windows-x64_bin-6219e3
else
    JVM_ARCH=$(linux$(getconf LONG_BIT) uname -m)
     case $JVM_ARCH in
        x86_64)
            JVM_URL=https://download.oracle.com/java/21/latest/jdk-21_linux-x64_bin.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jdk-21_linux-x64_bin-5f703d
            ;;
        aarch64)
            JVM_URL=https://download.oracle.com/java/21/latest/jdk-21_linux-aarch64_bin.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jdk-21_linux-aarch64_bin-3c96a0
            ;;
        *) 
            die "Unknown architecture $JVM_ARCH"
            ;;
